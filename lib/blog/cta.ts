...
export function getBlogCta(article: Pick<BlogArticle, "slug" | "h1">) {
  ...
  const options = [
    ...
    { matches: /부업|애드센스|애드포스트|쿠팡파트너스/, title: "부업 소득, 신고할 세금을 확인하세요", description: "소득과 비용을 정리해 종합소득세·부가세 검토가 필요한 부분을 확인합니다.", href: "/calculator/부업", calculatorType: "side_hustle" },
